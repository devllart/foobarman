...
Идеально в гастрономическом сочетании с морепродуктами и твёрдыми сырами.`,
	...
	"Cruzan Aged Light Rum": {
		Type:          "Крепкое/Белый Ром",
		Taste:         "Тростниковый",
		Alc:           40,
		AviableVolume: []float64{0.375, 0.75},
		Prices:        []float64{7.99, 13.19},
		Description:   "Карибский крепкий алкоголь получают методом вертикальной перегонки спирта,\nполученного путем брожения патоки или сока из сахарного тростника.\n Перед купажированием выдерживают не менее 12 месяцев в обожженных дубовых бочках из-под бурбона и фильтруют,\n чтобы обесцветить напиток.",
	},
}
